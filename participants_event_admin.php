...
<div class="header_area_all">
    ...
    <div class="profile_area">
            ...
            <tr onmouseover="this.style.background='rgba(0, 168, 247, 0.1)';" onmouseout="this.style.background='white';">
                ...
                <td>
                    <form method="post" action="application_admin.php" target="_blank" style="display: inline-block;">
                    ...
                    <?if (($mas['activity'] == '1') && ($type == '1')) {?>
                        <form method="post" action="cancel_participation_admin.php" target="_blank" style="display: inline-block;" onsubmit="return confirm('Вы дейcтвительно хотите отказать в участии данному пользователю?');">                        
                            <input type="hidden" name="id_event" value="<?=$id_event;?>">
                            <input type="hidden" name="type" value="<?=$type;?>"> 
                    ...
                    <?if (($mas['activity'] == '2') && ($type == '1')) {?>
                        <form method="post" action="activate_participation_admin.php" target="_self" style="display: inline-block;" onsubmit="return confirm('Вы дейcтвительно хотите подтвердить участие данного пользователя?');">                        
                            <input type="hidden" name="id_event" value="<?=$id_event;?>"> 
                            <input type="hidden" name="type" value="<?=$type;?>">    
                    ...
                    <?if (($mas['activity'] == '3') && ($type == '1')) {?>
                        <form method="post" action="return_participation_admin.php" target="_self" style="display: inline-block;" onsubmit="return confirm('Вы дейcтвительно вернуть на рассмотрение заявку данного пользователя?');">                        
                            <input type="hidden" name="id_event" value="<?=$id_event;?>">
                            <input type="hidden" name="type" value="<?=$type;?>">  
