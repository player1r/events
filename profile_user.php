<?php
    ...
    if ($id_user_watch == NULL) {
        $id_user_watch = $_GET['id'];
    }
    //Дата рождения
        //Наибольшая дата
    ...
    $org_status = $mysql->query("SELECT `org_status` FROM `users` WHERE `id` = '$id_user_watch'");
    ...
    $info = $mysql->query("SELECT `*` FROM `users` WHERE `id` = '$id_user_watch'");
    ...
    if(!empty($_POST)){
        ...
        if ($cancel != 1) {
            ...
            if($create_mode == "0"){
                ...
                $id_user_watch = filter_var(trim($_POST['id']),FILTER_SANITIZE_STRING);
                ...
                $mysql->query(
                    ...
                    `gender` = '$gender',
                    `birthday` = '$birthday'
                    WHERE `id` = '$id_user_watch';");

                // header("Refresh: 0;"); 
                header("location: profile_user.php?id=".$id_user_watch."");
...
<head>
    ...
    <title>Просмотр пользователя | Events</title>
    ...
    <div class="header_area_all">
        ...
        <div class="breadcrumbs_area">
            <div class="breadcrumbs_block">
                ...
                <a href="users_admin.php" class="selected_a">Пользователи</a><span class="image"></span>
                <a href="#" class="selected_a">Просмотр пользователя</a>
            </div>
        </div>
        ...
        <div class="profile_area" >
            <div class="profile_block">
                ...
                <h3 style=" margin-bottom: 20px;">Профиль пользователя ID: <span style="font-family: 'Open Sans';"><?=$user_info['id'];?></span></h3>
                <div class="info">
